  ...
  <body>
    <div class="container">
      <div class="weather-section">
        ...
        <p>
          {{ max_temp_label }}: {{ max_temp }}°C
        </p>
        <p>
          {{ min_temp_label }}: {{ min_temp }}°C
        </p>
        <p>
          {{ humidity_label }}: {{ humidity }}%
        </p>
        <p>
          {{ weather_desc_label }}: {{ weather }}
        </p>
      </div>
      <div class="analysis-section">
        <div class="tab" id="text-tab">
          ...
          <form id="text-form">
            ...
            <img id="loading-spinner-text" src="{{ url_for('static', filename='loading.gif') }}"
        ...
        <div class="tab" id="image-tab">
          ...
          <form id="image-form" enctype="multipart/form-data">
            ...
            <img id="loading-spinner-image" src="{{ url_for('static', filename='loading.gif') }}"
            alt="Loading..." style="display:none;">
          </form>
          <div id="image-response" class="response-box">
          </div>
    ...
    <script src="{{ url_for('static', filename='script-result.js') }}">
    </script>
  </body>
