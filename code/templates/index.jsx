...
<div class="image-scroll-container">
    <div class="image-scroll">
        ...
        <img src="{{ url_for('static', filename='public/image3_5_display.jpeg') }}" alt="Image description 3.5">
        ...
        <img src="{{ url_for('static', filename='public/image7_display.jpg') }}" alt="Image description 7">
        <img src="{{ url_for('static', filename='public/image6_display.jpeg') }}" alt="Image description 6">
        <img src="{{ url_for('static', filename='public/image8_display.jpg') }}" alt="Image description 8">
